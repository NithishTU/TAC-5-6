...
def setup_logger(adw_id: str, trigger_type: str = "adw_plan_build") -> logging.Logger:
    ...
    # Set encoding on the stream if possible (for Windows compatibility)
...
def get_safe_subprocess_env() -> Dict[str, str]:
    ...
    Note: Claude Code now uses local authentication via 'claude auth login'
    instead of ANTHROPIC_API_KEY for Claude Max subscriptions.
    ...
    safe_env_vars = {
        ...
        # Claude Code uses local authentication via 'claude auth login'
        ...
        # Cloudflare R2 Configuration (optional) - for review screenshots
        ...
        # Windows-specific environment variables (required for Node.js/Claude Code)
